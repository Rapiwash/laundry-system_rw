  ...
  return (
    <div className="content-setting">
      <div className="list-st">
        ...
        <Link to={`/${PrivateRoutes.PRIVATE}/${PrivateRoutes.SETTING_CATEGORIAS}`} className="tag-setting">
          <div className="img">
            <img src={categoriasSetting} alt="" />
          </div>
          <div>
            <h1>Categorias</h1>
            <p>Realiza Registros , Actualizaciones en Categorias de Productos y Servicios</p>
          </div>
        </Link>
        <Link to={`/${PrivateRoutes.PRIVATE}/${PrivateRoutes.SETTING_GASTOS}`} className="tag-setting">
          <div className="img">
          ...
          {iCategorias.length > 0 ? (
            <div className="portal-redirect-ps">
              ...
              <Button
                ...
                onClick={() => {
                  navigate(`/${PrivateRoutes.PRIVATE}/${PrivateRoutes.SETTING_SERVICIOS}`, { replace: true });
                }}
              >
                Servicios
              </Button>
